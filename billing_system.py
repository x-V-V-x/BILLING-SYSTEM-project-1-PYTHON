...
class Bill_App:
    def __init__(self, root):
        ...
        self.root.title("BILLING SOFT WERE")
        bg_color = "#badc57"
        title = Label(self.root, text="BILLING SOFT WERE", font=('times new roman', 30, 'bold'), pady=2, bd=12, bg="#00FFFF", fg="Black", relief=GROOVE) 
        title.pack(fill=X)
    # ================variables=======================
