...
class Bill_App:
    def __init__(self, root):
        ...
        self.root.title("PCU SMART MART")
        bg_color = "#badc57"
        title = Label(self.root, text="PCU SMART MART", font=('times new roman', 20, 'bold'), pady=0.5, bd=10, bg="#FF8247", fg="Black", relief=GROOVE) 
        title.pack(fill=X)
    # ================variables=======================
    ...
    # ==============Customer==========================
        ...
        self.erp_no = StringVar()
        self.bill_no = StringVar()
        x = random.randint(1000, 9999)
        self.bill_no.set(str(x))
        self.search_bill = StringVar()
        self.erp_no.set(str(x))
        self.search_erp_no = StringVar()
    # ===============Tax================================
        self.medical_tax = StringVar()
        self.grocery_tax = StringVar()
        self.cold_drinks_tax = StringVar()
    # =============customer retail details======================
        F1 = LabelFrame(self.root, text="Customer Details", font=('times new roman', 15, 'bold'), bd=5, fg="Black", bg="#98FB98")
        F1.place(x=0, y=65, relwidth=4)
        ...
        cname_txt = Entry(F1, width=8, textvariable=self.c_name, font='arial 15', bd=7, relief=GROOVE)
        ...
        cphn_txt = Entry(F1, width=8, textvariable=self.c_phone, font='arial 15', bd=7, relief=GROOVE)
        cphn_txt.grid(row=0, column=3, pady=5, padx=10)
        
        c_erp_no_lbl = Label(F1, text="ERP NUMPER:", bg="#badc57", font=('times new roman', 15, 'bold'))
        c_erp_no_lbl.grid(row=0, column=4, padx=10, pady=5)
        cphn_txt = Entry(F1, width=8, textvariable=self.search_erp_no, font='arial 15', bd=7, relief=GROOVE)
        cphn_txt.grid(row=0, column=5, pady=5, padx=10)

        c_bill_lbl = Label(F1, text="Bill Number:", bg="#badc57", font=('times new roman', 15, 'bold'))
        c_bill_lbl.grid(row=0, column=6, padx=10, pady=5)
        c_bill_txt = Entry(F1, width=8, textvariable=self.search_bill, font='arial 15', bd=7, relief=GROOVE)
        c_bill_txt.grid(row=0, column=7, pady=5, padx=10)

        bil_btn = Button(F1, text="Search", command=self.find_bill, width=10, bd=7, font=('arial', 12, 'bold'), relief=GROOVE)
        bil_btn.grid(row=0, column=8, pady=5, padx=10)


    # ===================Medical====================================
        F2 = LabelFrame(self.root, text="Medical Purpose", font=('times new roman', 15, 'bold'), bd=10, fg="Black", bg="#9AFF9A")
    ...
    # ==========GroceryItems=========================
        F3 = LabelFrame(self.root, text="Grocery Items", font=('times new roman', 15, 'bold'), bd=10, fg="Black", bg="#90EE90")
    ...
    # ===========ColdDrinks================================
        F4 = LabelFrame(self.root, text="Cold Drinks", font=('times new roman', 15, 'bold'), bd=10, fg="Black", bg="#7CCD7C")
    ...
    # =======Buttons-======================================
        ...
        total_btn = Button(btn_f, command=self.total, text="Total", bg="#FF0000", bd=2, fg="white", pady=15, width=12, font='arial 13 bold')
